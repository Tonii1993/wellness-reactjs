...
const BigCard = ({ title, description, imageSrc }) => {
  return (
    <div className="flex justify-center items-center mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl 2xl:max-w-screen-2xl md:px-24 lg:px-8 lg:py-20 px-4 py-16">
