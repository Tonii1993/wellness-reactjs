      ...
      <div className="flex flex-col lg:flex-row justify-between items-center md:px-12 xl:px-24 px-5 pt-24 gap-5">
        <div className="w-full lg:w-3/4 space-y-4">
          ...
          <p className="text-base text-justify lg:text-start">
            ...
            Sapiente at vero nisi tempore maiores officiis dolor! Cupiditate
            impedit voluptates natus vitae omnis, deleniti autem sed accusantium
            ab sapiente fuga facilis!.
          </p>
        </div>
