...
const OurServices = () => {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col justify-center  lg:px-10 px-5 pt-28">
        <div className="flex flex-col items-center lg:flex-row justify-between">
          <div>
            <h1 className="text-4xl font-semibold text-center lg:text-start md:pt-28 lg:pt-1">
              Our Services
            </h1>
