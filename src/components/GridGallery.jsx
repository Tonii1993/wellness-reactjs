...
const GridGallery = () => {
  ...
  const settings = {
    ...
    responsive: [
      {
        breakpoint: 1024, // iPad and tablet screens
        settings: {
          slidesToShow: 2,
          slidesToScroll: 1,
        },
  ...
  return (
    <>
      <div className="gallery-container hidden md:flex justify-center items-center xl:h-screen w-full">
        <div className="gallery-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-4">
          {cards.map((card) => (
            <div key={card.id}>
              <GalleryCard
                id={card.id}
