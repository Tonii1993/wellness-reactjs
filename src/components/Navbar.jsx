...
const Navbar = ({ openForm }) => {
  ...
  return (
    <div className="fixed w-full z-20 ">
      <div className="flex lg:flex-row px-5 justify-between items-center md:px-5 bg-PrimaryColor shadow-md">
        ...
        <div className="hidden xl:flex items-center justify-center text-center">
          <ul className="xl:flex lg:text-xl lg:space-x-5 2xl:space-x-10 2xl:text-2xl text-base text-[#A5A09C]">
            <li
              className="navbar-item  hover:text-ExtraDarkColor transition-all cursor-pointer"
            ...
            <li className="relative">
              <button
                className="bg-success focus:outline-none"
